...
public class OutboxEventJpaEntity {
    ...
    // Nullable: a platform-scoped action (a platform role grant, ADR-043) has no tenant to copy
    // this from. Every event about a real merchant still carries it -- null is the deliberate
    // exception, mirroring audit_events.merchant_id (V36).
    @Column(name = "merchant_id", nullable = true, length = 40)
